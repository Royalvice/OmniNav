...
- [x] 创建 `tests/sensors/test_sensors.py` 测试用例 <!-- id: sensor-test -->
...
- [x] 创建 `tests/locomotion/test_locomotion.py` 测试用例 <!-- id: loco-test -->
